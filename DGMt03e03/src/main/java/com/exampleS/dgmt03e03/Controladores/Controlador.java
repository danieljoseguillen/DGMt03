package com.exampleS.dgmt03e03.Controladores;
...
public class Controlador {
    ...
    //public String home(@RequestParam (required = false, defaultValue = "0") String nom, Model model) 
    public String home(@RequestParam Optional <String> nom, Model model) 
    { 
        model.addAttribute("annos", (LocalDate.now().getYear() - 1999));
        //model.addAttribute("nombre", nom);
        model.addAttribute ("nombre", nom.orElse(""));
        return "indexView";
    }
